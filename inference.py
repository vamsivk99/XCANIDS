...
#   --data_path: A path to one or more tfrecord files as generated by train_val_test.py or preprocessing_labeled.py as string
#   --model_path: A path to trained model as produced by train.py as string
